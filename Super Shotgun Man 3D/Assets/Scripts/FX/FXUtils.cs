...
public static class FXUtils
{
    ...
    public static void InstanceFXObject(int o, Vector3 position, Quaternion rotation, Transform parent = null, bool alt_mode = false, int damage = 75, float duration = 0.5f, float max_radius = 1.0f, float volume = 1.0f)
    {
        ...
        switch (o)
        {
            case 2:
                ...
                AudioUtils.InstanceSound(4, instance.transform.position, instance.GetComponent<ExplosionBehavior>(), null, true, volume, MathUtils.GaussianRandom(0.75f, 1.25f));
                break;
        }
    }
}
